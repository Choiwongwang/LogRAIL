...
# -----------------------------------------------------------------------------
# Set input/output directories and log filename (overridable via CLI)
# -----------------------------------------------------------------------------
DEFAULT_INPUT_DIR = r'/home/irv4/HybridTransformer/DataFile'
DEFAULT_OUTPUT_DIR = r'/home/irv4/HybridTransformer/DataFile'
DEFAULT_LOG_FILE = 'anormal_logs.txt'  # actual log filename

# -----------------------------------------------------------------------------
# Android log format string (for arg shape; not used in parse)
# -----------------------------------------------------------------------------
android_format = "<Date> <Time> <Pid> <Tid> <Level> <Component>: <Content>"
...
if __name__ == "__main__":
    ...
    ap.add_argument("--input_dir", default=DEFAULT_INPUT_DIR, help="Input directory")
    ap.add_argument("--output_dir", default=DEFAULT_OUTPUT_DIR, help="Output directory")
    ap.add_argument("--log_file", default=DEFAULT_LOG_FILE, help="Log filename in input_dir")
    args = ap.parse_args()
